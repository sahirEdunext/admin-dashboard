    ...
    <div class="container-full font-hind">
        ...
        <section class="content">
            <div class="d-flex justify-content-between bd-highlight align-items-center my-3 px-1_25">
                <div><h2 class="intro-heading my-0"><span class="h2span">Setup &gt;</span> Voucher Type</h2></div>
                                ...
                                <div class="tab-pane active" id="tcFRequest" role="tabpanel">
                                    ...
                                    <div class="px-1">
                                        <div class="box-body pt-2 py-4">
                                            <div class="">
                                                <table class="table sk_book_table dataTable font-hind as_tbl">
                                                    <thead>
                                                        <tr role="row">
															<th>
                                                            ...
                                                            <th>Name</th>
                                                            <th>Voucher Type</th>
                                                            <th class="as_tl">Is Check Mandatory</th>
                                                            <th>Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
																				...
																				<div class="row sk_dropdown">
																					<div class="col-md-12">
																						<div class="form-group">
																						  <input type="text" class="form-control text-fil" placeholder="Short Name">
																						</div>
																					</div>
																						<div class="col-md-12">
																						<div class="form-group">
																						  <input type="text" class="form-control text-fil" placeholder="Name">
																						</div>
																					</div>
																					 <div class="col-md-12">
                                                                        <select class="selectpicker" name="Voucher Type"
                                                                            id="">
                                                                            <option>Voucher Type</option>
                                                                            <option>Open</option>
                                                                        </select>
                                                                    </div>
																		<div class="col-md-12 d-flex justify-content-between of-bt">
																					<p>	Is Check Mandatory</p>
															...
															<div class="modal center-modal sk_modal fade" id="ledgerFilter" tabindex="-1" aria-hidden="true">
																<div class="modal-dialog">
																	...
																	<div class="modal-body">
																		...
																		<button type="button" class="btn-mr btn dropdown-toggle btn-default" data-bs-toggle="dropdown" role="button" data-id="" title="Voucher Type" aria-expanded="false">
																		<span class="filter-option pull-left">Voucher Type</span>&nbsp;<span class="bs-caret"><span class="caret"></span></span>
																		</button>
																		<div class="dropdown-menu open" role="combobox" style="max-height: 287.5px; overflow: hidden; min-height: 0px;">
																		<ul class="dropdown-menu inner" role="listbox" aria-expanded="false" style="max-height: 285.5px; overflow-y: auto; min-height: 0px;">
																		<li data-original-index="0" class="selected"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="true"><span class="text">Voucher Type</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
																		<li data-original-index="1"><a tabindex="0" class="" data-tokens="null" role="option" aria-disabled="false" aria-selected="false"><span class="text">Open</span><span class="glyphicon glyphicon-ok check-mark"></span></a></li>
																		</ul>
																		</div>
																		</div>
                                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-7">
                                                        <div class="dataTables_paginate paging_simple_numbers" id="complex_header_paginate">
                                                            <ul class="pagination justify-content-end m-0">
                                                                ...
                                                                <li class="paginate_button page-item next" id="complex_header_next"><a href="#" class="page-link">Next</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
