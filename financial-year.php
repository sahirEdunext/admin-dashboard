...
<section class="content">
   <div class="d-flex justify-content-between bd-highlight align-items-center my-3 px-1_25">
      <div>
         <h2 class="intro-heading my-0"><span class="h2span">Setup ></span> Financial Year</h2>
      </div>
      <div>
                     ...
                     <ul class="px-1_25 py-2 d-flex sk_header_bg align-items-center justify-content-end m-0" role="tablist">
                        ...
                        <li class="mb-0 sk_p_rela">
                           <a class="sk_add_tc ms-2">
                              ...
                              <span data-bs-toggle="modal"  data-bs-target="#ledgerFilter">Add Financial years</span>
                           </a>
                        </li>
                     </ul>
                     <div class="px-1">
                                       ...
                                       <tr class="sk_row_hover mv-tbl-book-history-row" role="row">
                                          ...
                                          <td class="">
                                             <div class="d-flex justify-content-end align-items-center">
                                                ...
                                                <img class="icon_height" src="assets/images/delete.svg" alt="">
                                                         ...
                                                         <div class="modal-body">
                                                            <form action="">
                                                               <div class="row sk_dropdown">
                                                                  ...
                                                                  <div class="col-md-12">
                                                                     <div class="form-group">
                                                                        <input type="text" class="form-control" placeholder="Assessment Year">
                                                                     </div>
                                                                  </div>
                                                                  <div class="col-md-6">
                                                                  ...
                                                                  <div class="col-sm-12 d-flex justify-content-between mt-10">
                                                                     <p>Is Financial Year Frezzed</p>
                                                                     <button type="button" class="btn btn-sm btn-secondary btn-toggle me-0" data-toggle="button" aria-pressed="true" autocomplete="off">
                                                                        <div class="handle"></div>
                                                                     </button>
                                                                  </div>
                                                               </div>
