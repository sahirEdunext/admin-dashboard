<?php
   ...
   ?>
   <title>Report Other Report Multiple Voucher Report</title>
   <style>
      .color_label{
         color: #7A86A5;
      }
   ...
   <div class="container-full font-hind">
      ...
      <section class="content">
         <div class="d-flex justify-content-between bd-highlight align-items-center my-3 px-1_25">
            <div>
               <h2 class="intro-heading my-0"><span class="h2span">Report > Other Report > </span> Multiple Voucher Report</h2>
            </div>
            <div>
                     ...
                     <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="studentLedgerAccount" role="tabpanel">
                           <ul class="px-1_25 py-2 d-flex sk_header_bg align-items-center justify-content-between m-0"
                              role="tablist">
                              <li class="mb-0">
                                <span class="text-dark">Multiple Voucher Information</span>
                              </li>
