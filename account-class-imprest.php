<?php
   ...
   ?>
   <title>Class Wise Imprest Account Class Imprest</title>
   <style>
      .color_label{
         color: #7A86A5;
      }
...
.boxed input[type="radio"]{position: absolute;right: 25px;top: 9px;}

.boxed input[type="radio"]:checked + label {
  background-color: #7A86A50D;
}
   ...
   <div class="container-full font-hind">
      ...
      <section class="content">
         <div class="d-flex justify-content-between bd-highlight align-items-center my-3 px-1_25">
            <div>
               <h2 class="intro-heading my-0"><span class="h2span">Report > Imprest Account ></span> Class Imprest</h2>
            </div>
            <div>
                                 ...
                                 <div class="custom_heightmin">
                                    <div class="row">
                                                   ...
                                                   <div class="col-sm-6 mt-2">
                                                      ...
                                                      <input type="text" class="form-control" placeholder="Enter Minimum Imprest Balance" value="Enter Minimum Imprest Balance">
                                                   </div>
                                                   <div class="col-sm-6 mt-2">
                                                      <label for="Maximum Imprest Balance" class="ps-3 pb-1 color_label">Maximum Imprest Balance</label>
                                                      <input type="text" class="form-control" placeholder="Enter Maximum Imprest Balance" value="Enter Maximum Imprest Balance">
                                                   </div>
                                                   <div class="col-sm-6 mt-3">
                                                   <p class="ps-3">Select File Type</p>
                                                   <form class="boxed ps-3 d-flex">
                                                      <div class="input_01_radio">
                                                      <input type="radio" checked id="android" name="skills" value="Android Development">
                                                      <label class="boxed" for="android">SMS</label>
                                                      </div>

                                                      <div class="input_01_radio">
                                                      <input type="radio" id="ios" name="skills" value="iOS Development">
                                                      <label class="boxed" for="ios">Email</label>
                                                      </div>
                                                      </form>
                                                   </div>
                                                   <div class="col-sm-6 mt-3">
                                                   <p class="ps-3">Select File Type</p>
                                                   <div class="d-flex">
                                                      <div class="radion_01 me-20" onclick="onSelectUserType(1)">
